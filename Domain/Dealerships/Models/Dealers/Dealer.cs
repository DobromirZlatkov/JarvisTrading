namespace JarvisTrading.Domain.Dealerships.Models.Dealers
{
    ...
    public class Dealer : Entity<int>, IAggregateRoot
    {
        ...
        internal Dealer(string name, string phoneNumber, string userId)
        {
            this.Validate(name);
        ...
        private Dealer(string name, string userId)
        {
            this.Name = name;
