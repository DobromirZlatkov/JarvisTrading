namespace JarvisTrading.Application.Dealerships.Dealers.Commands.Create
{
    ...
    public class CreateDealerCommand : IRequest<CreateDealerOutputModel>
    {
        ...
        public class CreateDealerCommandHandler : IRequestHandler<CreateDealerCommand, CreateDealerOutputModel>
        {
            ...
            public async Task<CreateDealerOutputModel> Handle(CreateDealerCommand request, CancellationToken cancellationToken)
            {
